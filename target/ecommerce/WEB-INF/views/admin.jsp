		...
		<div class="row mt-3">
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="card-body text-center" onclick='window.location.href="admin?page=users"'>
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="card-body text-center" onclick='window.location.href="admin?page=categories"'>
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="card-body text-center" onclick='window.location.href="admin?page=products"'>
		...
		<div class="row mt-3">
			...
			<div class="col-md-4">
				...
				<div class="card">
					...
					<div class="card-body text-center" onclick='window.location.href="admin?page=orders"'>
